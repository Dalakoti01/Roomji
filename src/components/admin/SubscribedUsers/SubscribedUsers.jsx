...
import SubscribedUsersList from '../Users/SubscribedUsersList';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Subscribed Users</h1>
      </div>
      ...
      <SubscribedUsersList searchQuery={searchQuery} />
    </div>
  );
}
